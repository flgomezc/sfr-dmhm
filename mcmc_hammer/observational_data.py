...
# ODn = list[ array[magnitude,                               # Abs. Mag. units
#                   luminosity function,                     # Mpc^-3 h^+3
#                   zeros?, 
#                   magnitude_bin_width],                    # Abs. Mag. units
#             list[ magnitude_bins ],
#             list[ log10(upper_error)+log10(lower_error) ],
#             string( name_of_dataset )
#             float( Boxlength ) ]                          # in Mpc h-1
...
OD2 = [
 array([
        [ -2.25200000e+01,  -2.20200000e+01,  -2.15200000e+01, 
        ...
        [  4.00000000e-06,   2.20000000e-05,   5.80000000e-05,
           ...
           9.42000000e-03]]),
 [-22.7,-22.27,-21.77,-21.27,-20.77,-20.27,-19.77,-19.27,-18.27,-17.27,-16.27],
 array([ 0.42254902,  0.16549661,  0.1149272 ,  0.0918222 ,  0.06875137,
         0.06642636,  0.05755340,  0.07653151,  0.09832118,  0.14226791]),
 'Bouwens',
 125.0]

OD3 = [
 array([
        [ -2.21200000e+01,  -2.17500000e+01,  -2.15000000e+01,
...
OD4 = [
 array([
        [ -2.20000000e+01,  -2.15000000e+01,  -2.10000000e+01,
