...
We also include a fixed intrinsic scatter in the mass to SFR
relationship... %http://arxiv.org/pdf/1507.00999.pdf
...
explored by the observations: the Big MultiDark Planck (MDPL) and
Planck-Bolshoi (P-Bolshoi).  
Both simulations use cosmological parameters consistent with 2013
Planck results: $\Omega_M = 0.307$, $\Omega_B = 0.048$, $\Omega_\Lambda =
0.730$, $\sigma_8 = 0.829$, $n_s = 0.96$ and  $H_0 = 67.8$.  

The MDPL is a N-body dark matter only simulation ran unsing the
L-Gadget2 code.
The simulated volume is a cubic box of $1000$ \hMpc on a side.
It has $3840^3$ dark matter particles mass of $1.51\times 10^{9}$ \hMsun.
The halo catalog at $z=6$ is built using the Bound Density Maxima algorithm.
We split the simulation volume into 64 smaller cubic boxes of
$250$\hMpc to study the influence of cosmic variance in matching the
observations  by \citet{Willott13} 

The P-Bolshoi simulation follows the non-linear evolution of $2048^3$
particles in a cubic box of $250$ \hMpc on a side.
This translates into a mass resolution of $1.35\times 10^{8}$ \hMsun
per particle. We split this simulation into $8$ smaller cubic boxes of
$125$ \hMpc on a side to study cosmic variance in matching the
observations by \citet{McLure09, Finkelstein14, Bouwens15}
...
$\gamma\times0.1$          & $4.028_{-0.82}^{+3.01}$ & 0.58 & $ 5.18_{-0.59}^{+2.36}$ & 0.58  \\
\hline\hline
\end{tabular}
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla accumsan elementum leo at ornare. Curabitur at ligula ac purus ultrices suscipit in non leo. Aliquam erat volutpat. Curabitur sit amet lectus ligula. Sed tincidunt urna ac felis sodales, non accumsan lorem porta. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur risus dolor, sollicitudin sit amet fringilla volutpat, convallis eu nibh. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed vulputate elit sit amet risus interdum, nec efficitur velit aliquam. Mauris nec scelerisque nisi, sed accumsan nunc. Pellentesque elementum pulvinar magna. Donec eleifend luctus libero vitae fermentum. Proin eu viverra est. Duis eget congue libero, nec iaculis libero.
...
\begin{tabular}{cccccc}\hline\hline
 & \multicolumn{2}{c}{Dust Att.} & \multicolumn{2}{c}{No-Dust Att.}\\
Parameter                  & MCMC                  & C.Var. & MCMC                    & C.Var. \\\hline
$\log_{10}(L_0/L_{\odot})$ & $18.27_{-0.22}^{+0.33}$ & 0.03 & $17.81_{-0.16}^{+0.22}$ & 0.06  \\
$\log_{10}(M_0/M_{\odot})$ & $11.43_{-0.49}^{+0.57}$ & 0.07 & $11.82_{-0.32}^{+1.02}$ & 0.13  \\
$\beta$                    & $ 0.88_{-0.27}^{+0.39}$ & 0.18 & $ 0.91_{-0.48}^{+0.63}$ & 0.04  \\
$\gamma\times0.1$          & $ 1.41_{-1.41}^{+7.58}$ & 0.58 & $ 1.34_{-1.34}^{+6.77}$ & 0.13  \\
\hline\hline
\end{tabular}
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD2_w_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD2_wo_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD3_w_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD3_wo_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD4_w_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD4_wo_dust_box_1.png} % pdf available
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD2_plotcosmicvariance_wo_dust.pdf}
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD3_plotcosmicvariance_w_dust.pdf}
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD3_plotcosmicvariance_wo_dust.pdf}
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD4_plotcosmicvariance_w_dust.pdf}
...
\begin{figure}
\epsscale{1.00}
\plotone{fig/smallcells/OD4_plotcosmicvariance_wo_dust.pdf}
\caption{Best fit parameter distribution due cosmic variance with McLure data in the no-dust
 attenuation model.}
\label{fig:OD3_CosmicVar1_wo_dust}
\end{figure}
