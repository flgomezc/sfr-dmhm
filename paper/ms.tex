...
\shortauthors{Gomez, Forero-Romero}

\author{Felipe Gomez, Jaime E. Forero-Romero}  
...
\begin{abstract}
We procent updated constraints between the star formation rate and
...
The constrains are based on an abundance matching method using data
